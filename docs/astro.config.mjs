			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'Authentication & Security', slug: 'api/authentication' },
						{ label: 'Ingest API', slug: 'api/ingest-api' },
						{ label: 'Management API', slug: 'api/management-api' },
						{ label: 'Event Schema', slug: 'api/events' },
						{ label: 'Webhooks', slug: 'api/webhooks' },
						{ label: 'SDKs & Components', slug: 'api/sdks' },
						{ label: 'OpenAPI 3.1 Spec', slug: 'api/openapi-spec' },
					],
				},
			],
		}),
